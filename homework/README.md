...
# Ответы:
1. Проще начать с реализации тестов, так как будем знать их потребности 
2. Для удобства использования/получения элементов
3. __hash__ нужен для определения Product как словаря